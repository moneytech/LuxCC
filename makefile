...
uninstall:
	rm -f /usr/local/bin/luxcc /usr/local/bin/luxdvr /usr/local/bin/luxas /usr/local/bin/luxld32 /usr/local/bin/luxld64 /usr/local/bin/luxvm /usr/local/bin/luxasvm /usr/local/bin/luxldvm /usr/local/bin/luxasmips /usr/local/bin/luxldmips /usr/local/bin/luxmipsemu
